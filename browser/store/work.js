...
export const createWorkThunk = work => dispatch => {
  axios.post(`http://localhost:4002/api/minions/${work.minionId}/work`, work)
  .then(res => res.data)
  .then(createdWork => {
...
export const updateWorkThunk = work => dispatch => {
  axios.put(`http://localhost:4002/api/minions/${work.minionId}/work/${work.id}`, work)
  .then(res => res.data)
  .then(updatedWork => {
...
export const deleteWorkThunk = work => dispatch => {
  axios.delete(`http://localhost:4002/api/minions/${work.minionId}/work/${work.id}`)
  .then(() => {
